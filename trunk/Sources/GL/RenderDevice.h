...
namespace GL
{
    ...
    protected:
        ...
        void                CheckPrimitiveTopology      ( GLenum Mode, const char *Method ) const;
    ...
    public:
        ...
        virtual void        Blit                        ( Ptr<CFrameBufferObject> DestFrameBuffer, Ptr<const CFrameBufferObject> SrcFrameBuffer, GLbitfield Mask, GLenum Filter ) const;
        virtual void        CopyDepthStencilToColor     ( GLint x, GLint y, GLsizei Width, GLsizei Height, GLenum Type ) const;
        virtual void        CopyPixels                  ( GLint x, GLint y, GLsizei Width, GLsizei Height, GLenum InputFormat, GLenum OutputFormat, GLenum Type, Ptr<CBuffer> Buffer ) const;

        //
        // Texture/Shader
        //

                            // Данный метод предназначен только для FFP.
                            // Вместо него используйте методы класса ISamplerUniform.
        ...
        virtual void        DrawArraysInstanced         ( GLenum Mode, GLint First, GLsizei Count, GLsizei PrimCount ) const;
        virtual void        DrawElements                ( GLenum Mode, GLint First, GLsizei Count ) const;
        virtual void        DrawElementsInstanced       ( GLenum Mode, GLint First, GLsizei Count, GLsizei PrimCount ) const;
        virtual void        DrawRangeElements           ( GLenum Mode, GLint First, GLuint Start, GLuint End, GLsizei Count ) const;
    };
