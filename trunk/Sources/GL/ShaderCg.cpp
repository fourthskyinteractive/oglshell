        ...
        m_Program( NULL )
    {
        ...
        try
        {
            ...
            if (!m_Program)
            {
                ...
                throw CCgException( "GL::CCgShader", cgGetError(), "::CCgShader() : Failed to create Cg %s shader.", TypeName );
            }
            ...
            {
                m_LastListing = CCgContext::GetLastListing();
                throw CCgException( "GL::CCgShader", Error, "::CCgShader() : Failed to compile Cg %s shader. See program log for more details.", TypeName );
            }
        }
