...
namespace GL
{
    ...
    CFrameBuffer::CFrameBuffer( 
                               GLenum ColorFormat, GLenum DepthStencilFormat, GLuint NumSamples, GLuint NumAuxBuffers, ELayerType LayerType, 
    ...
    #endif // _WIN32
    {
        ...
        else 
        {
            ...
            {
                throw Sys::CDeveloperException( this, "::CFrameBuffer() : Floating-point P-buffer unsupported." );
			}
        }
    ...
    */
    ...
    void CFrameBuffer::Present() const
    {
        ...
        if (!m_Current)
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERR_INVALID_CALL,
        ...
        for (MAP_CONST_ITERATION( GLenum, TAttachmentState, m_Attachments, i ))
        {
                                         ...
                                         ) const
    {
        ...
        case GL_RGB8:
            ...
            break;
        case GL_RGBA16F_ARB:
            Desc->NumAlphaBits = 16;
        case GL_RGB16F_ARB:
            Desc->NumRedBits = 16;
            Desc->NumGreenBits = 16;
            Desc->NumBlueBits = 16;
            Desc->PixelType = PT_FLOAT;
            break;
        case GL_RGBA32F_ARB:
            Desc->NumAlphaBits = 32;
        case GL_RGB32F_ARB:
            Desc->NumRedBits = 32;
            Desc->NumGreenBits = 32;
            Desc->NumBlueBits = 32;
            Desc->PixelType = PT_FLOAT;
            break;

        default:
            throw Sys::CDeveloperException( this, "::ChoosePixelFormat() : Unknown <ColorFormat> parameter. FIXME." );
        }

        switch (DepthStencilFormat)
        {
        case GL_DEPTH_COMPONENT16:
            Desc->NumDepthBits = 16;
            break;
        case GL_DEPTH_COMPONENT24:
            Desc->NumDepthBits = 24;
            break;
        case GL_DEPTH_COMPONENT32:
            Desc->NumDepthBits = 32;
            break;
        ...
        default:
            throw Sys::CDeveloperException( this, "::ChoosePixelFormat() : Unknown <DepthStencilFormat> parameter. FIXME." );
        }
    }
