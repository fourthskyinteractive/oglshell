...
// Τΰιλ: /GL/GL/ExtensionRegistry.cpp
//    
...
#ifdef _DEBUG
//#define GLSHELL_VALIDATE_EXTENSIONS_NAMES
#endif
...
namespace GL 
{
    ...
    {
    #ifdef GLSHELL_VALIDATE_EXTENSIONS_NAMES
    ...
    #endif // GLSHELL_VALIDATE_EXTENSIONS_NAMES
    ...
    void CRegistry::TokenizeString()
    {
        ...
        vector<char> Str( strlen( m_ExtensionsStr ) + 1 );
        strcpy( &Str[ 0 ], m_ExtensionsStr );
