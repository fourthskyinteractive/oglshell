...
namespace GL 
{
    ...
    CObject::CObject()
    {
        // Сбросим кэш ошибок OpenGL перед тем, 
        // как будет вызван конструктор производного класса.          
        glClearErrors();
    }
                                     ...
                                     ) const
    {
        ...
        {
        case GL_NO_ERROR:
            throw Sys::CDeveloperException( Sys::CDeveloperException::ERROR_INVALID_THROW, "No OpenGL errors has occured." ); 
        ...
        default:
            throw Sys::CDeveloperException( Sys::CDeveloperException::ERROR_INVALID_ENUM, "Unknown OpenGL error code." );
        }
                                       ...
                                       ) const
    {
        ...
        {
        case CG_NO_ERROR:
            throw Sys::CDeveloperException( Sys::CDeveloperException::ERROR_INVALID_THROW, "No Cg errors has occured." ); 
        ...
        default:
            throw Sys::CDeveloperException( Sys::CDeveloperException::ERROR_INVALID_ENUM, "Unknown Cg error code." );
        }
    ...
    // Constructor
    //
    CDeprecatedException::CDeprecatedException( 
                                               const Sys::IRTTIObject *Obj, const char *Method, int MajorNumber, int MinorNumber
                                               )
    {
        char MessageStr[ MAX_STRING ];
        
        sprintf( MessageStr, "%s\n\n%s : This functionality is deprecated in OpenGL %d.%d.", 
            Obj->GetClassName().c_str(), Method, MajorNumber, MinorNumber );
    ...
    // glVertexAttrib2fv
    //
    void glVertexAttrib2fv( int Index, const Vec2<GLfloat>& v )
    {
    ...
    // glVertexAttrib3fv
    //
    void glVertexAttrib3fv( int Index, const Vec3<GLfloat>& v )
    {
    ...
    // glVertexAttrib4fv
    //
    void glVertexAttrib4fv( int Index, const Vec4<GLfloat>& v )
    {
