...
namespace Math
{
    ...
    public:
        ...
        Mat3                ToMat3() const; // Cм. Postponed.h
        Mat4                ToMat4() const; // Cм. Postponed.h
        ...
        Vec3<T>&            operator *= (const Mat3& m); // Cм. Postponed.h  
        Vec3<T>&            operator *= (const Mat4& m); // Cм. Postponed.h  
        Vec3<T>&            operator *= (const Quat4<T>& q); // Cм. Postponed.h
        Vec3<T>&            operator /= (const T& s);
        Vec3<T>&            operator /= (const Vec3<T>& v);
        Vec3<T>&            operator += (const T& s);
        Vec3<T>&            operator += (const Vec3<T>& v);
