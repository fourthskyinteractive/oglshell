...
// Τΰιλ: /GL/GL/RenderDevice_Release.cpp
//
...
namespace GL
{
    ...
    void CRenderDeviceRelease::Blit( 
                                    Ptr<CFrameBufferObject> DestFrameBuffer, Ptr<const CFrameBufferObject> SrcFrameBuffer, 
    ...
    void CRenderDeviceRelease::CopyPixels( 
                                          ...
                                          GLenum InputFormat, GLenum OutputFormat, GLenum Type, 
                                          Ptr<CBuffer> Buffer 
                                          ) const
    {
