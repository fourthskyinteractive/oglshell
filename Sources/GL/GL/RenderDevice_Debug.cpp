...
// Файл: /GL/GL/RenderDevice_Debug.cpp
//
...
namespace GL
{
                                            ...
                                            )
    {
        if (m_FrameBuffer)
        {
            if (m_FrameBuffer->m_Type == IFrameBuffer::FBT_FRAMEBUFFER_OBJECT && 
                FrameBuffer->m_Type == IFrameBuffer::FBT_PBUFFER)
            {
                glClearErrors();
        ...
        else 
        {
            ...
            else 
            {
                ...
                {
                    GLint NumDrawBuffers = static_cast<int>( FrameBuffer->m_DrawBuffers.size() );
                    if (NumDrawBuffers > m_Caps.MaxDrawBuffers)
                    {
                        throw Sys::CException( this, "::SetFrameBuffer() : Number of draw buffers exceed implementation-dependent constant GL_MAX_DRAW_BUFFERS=%d.", 
                            m_Caps.MaxDrawBuffers );
                    }

                    vector<GLenum> Buffers;

                    for (CONST_SET_ITERATION( GLenum, FrameBuffer->m_DrawBuffers, i ))
                        Buffers.push_back( *i );
                                             ...
                                             )
    {
        ...
        { 
            if (!m_VertexStruct)
                throw Sys::CDeveloperException( this, "::SetVertexBuffer() : Currently there is no vertex structure to be used." );
            if (m_VertexStruct->m_Attributes[ StreamIndex ].size() == 0)
                throw Sys::CDeveloperException( this, "::SetVertexBuffer() : Invalid <StreamIndex> parameter for currently bound vertex structure." );
                
            if (Stride < 0)
                Stride = m_VertexStruct->m_Strides[ StreamIndex ];
                
            glBindBuffer( GL_ARRAY_BUFFER, Buffer->m_Buffer );
            for (CONST_MAP_ITERATION( GLuint, CVertexStructure::TAttrib, m_VertexStruct->m_Attributes[ StreamIndex ], i ))
                                            ...
                                            )
    {
        if (Buffer)
        {
            if (IndexType != GL_UNSIGNED_BYTE && IndexType != GL_UNSIGNED_SHORT && IndexType != GL_UNSIGNED_INT)
                throw Sys::CDeveloperException( this, "::SetIndexBuffer() : Invalid <IndexType> parameter." );    
        }
        else if (IndexType != GL_NONE)
            throw Sys::CDeveloperException( this, "::SetIndexBuffer() : For consistency, <IndexType> parameter should be GL_NONE." );
                                                    ...
                                                    )
    {
        if (!m_Extensions->NV_conditional_render && !m_Extensions->NVX_conditional_render)
            throw CExtensionException( this, "::BeginConditionalRender()", "GL_NV/NVX_conditional_render" );
            
        if (!Query)
            throw Sys::CDeveloperException( this, "::BeginConditionalRender() : Invalid <Query> parameter." );
    ...
    {
        if (!m_Extensions->NV_transform_feedback)
            throw CExtensionException( this, "::BeginTransformFeedback()", "GL_EXT/NV_transform_feedback" );
        ...
        if (!m_FeedbackBuffer)
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::BeginTransformFeedback() : Transform feedback buffer must be bound to perform the operation." );
        }
    ...
    {
        if (!m_Extensions->NV_transform_feedback)
            throw CExtensionException( this, "::EndTransformFeedback()", "GL_EXT/NV_transform_feedback" );
    ...
    {
        if (IsDeprecatedTopology( Mode ))
            throw Sys::CDeveloperException( this, "::DrawArrays() : Deprecated primitive topology: %s.", ToString( Mode ) );
        if (!IsSupportedTopology( Mode ))
            throw CExtensionException( this, "::DrawArrays()", "GL_EXT_geometry_shader4" );

        if (!IsVertexBufferBound())
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawArrays() : At least one vertex buffer must be bound to perform the draw call." );
        }
                                                 ...
                                                 ) const
    {
        ...
        if (IsDeprecatedTopology( Mode ))
            throw Sys::CDeveloperException( this, "::DrawArraysInstanced() : Deprecated primitive topology: %s.", ToString( Mode ) );
        if (!IsSupportedTopology( Mode ))
            throw CExtensionException( this, "::DrawArraysInstanced()", "GL_EXT_geometry_shader4" );

        if (!IsVertexBufferBound())
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawArraysInstanced() : At least one vertex buffer must be bound to perform the draw call." );
        }
    ...
    {
        if (IsDeprecatedTopology( Mode ))
            throw Sys::CDeveloperException( this, "::DrawElements() : Deprecated primitive topology: %s.", ToString( Mode ) );
        if (!IsSupportedTopology( Mode ))
            throw CExtensionException( this, "::DrawElements()", "GL_EXT_geometry_shader4" );

        if (!IsVertexBufferBound())
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawElements() : At least one vertex buffer must be bound to perform the draw call." );
        }
        if (!m_IndexBuffer)
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawElements() : Index buffer must be bound to perform the draw call." );
        }
                                                   ...
                                                   ) const
    {
        ...
        if (IsDeprecatedTopology( Mode ))
            throw Sys::CDeveloperException( this, "::DrawElementsInstanced() : Deprecated primitive topology: %s.", ToString( Mode ) );
        if (!IsSupportedTopology( Mode ))
            throw CExtensionException( this, "::DrawElementsInstanced()", "GL_EXT_geometry_shader4" );

        if (!IsVertexBufferBound())
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawElementsInstanced() : At least one vertex buffer must be bound to perform the draw call." );
        }
        if (!m_IndexBuffer)
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawElementsInstanced() : Index buffer must be bound to perform the draw call." );
        }
    ...
    {
        if (IsDeprecatedTopology( Mode ))
            throw Sys::CDeveloperException( this, "::DrawRangeElements() : Deprecated primitive topology: %s.", ToString( Mode ) );
        if (!IsSupportedTopology( Mode ))
            throw CExtensionException( this, "::DrawRangeElements()", "GL_EXT_geometry_shader4" );

        if (!IsVertexBufferBound())
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawRangeElements() : At least one vertex buffer must be bound to perform the draw call." );
        }
        if (!m_IndexBuffer)
        {
            throw Sys::CDeveloperException( this, Sys::CDeveloperException::ERROR_INVALID_CALL,
                "::DrawRangeElements() : Index buffer must be bound to perform the draw call." );
        }
