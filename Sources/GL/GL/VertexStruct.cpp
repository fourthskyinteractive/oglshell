...
namespace GL
{
        ...
        m_VertexSize( 0 )
    {
        ...
        for (CONST_VECTOR_ITERATION( TDesc, Attributes, i ))
                                        ...
                                        )
    {
        ...
        {
            throw Sys::CException( this, "::AddAttribute() : Invalid <Attrib> parameter.\nIndex exceed implementation-dependent constant GL_MAX_VERTEX_ATTRIBS=%d.",
                m_Caps.MaxVertexAttribs );
        }
