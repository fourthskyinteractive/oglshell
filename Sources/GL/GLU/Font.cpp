...
namespace GLU
{
        ...
        m_GlyphsCount( GlyphsCount )
    {
        ...
        if (Error != GL_NO_ERROR)
            throw GL::CException( this, Error, "::CFont() : Failed to generate display lists." );
    }
    ...
    // DrawText
    //
    void CBitmapFont::DrawText( GLint x, GLint y, const string& Str ) const
    {
    ...
    // DrawText
    //
    void CBitmapFont::DrawText( GLint x, GLint y, const char *Str ) const
    {
    #ifdef _DEBUG
        if (!Str) 
    ...
    // DrawFormatText
    //
    void CBitmapFont::DrawFormatText( GLint x, GLint y, const char *FormatStr, ... ) const
    {
    #ifdef _DEBUG
        if (!FormatStr) 
        ...
        static char Str[ CFont::MAX_STRING ];
        va_list ArgList;
